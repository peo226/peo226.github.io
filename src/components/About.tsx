      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start">
          <div className="md:w-2/3">
            ...
            <p className="mb-4">
              As a computer science student at Lehigh University, I am passionate about exploring the 
              intersection of software development and machine learning. My academic journey has been 
              focused on building a strong foundation in algorithm design, data structures, and 
              artificial intelligence principles.
            </p>
            <p className="mb-4">
              Outside of my coursework, I spend my time developing my skills in game development, 
              particularly using the Roblox platform. This creative outlet allows me to combine my 
              technical knowledge with my passion for creating interactive and engaging experiences.
            </p>
            <p>
              I am particularly interested in exploring how AI and machine learning can enhance 
          ...
          <div className="md:w-1/3 bg-white p-6 rounded-lg shadow-sm border border-border">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span>Computer Science student with Data Science minor</span>
              </li>
              <li className="flex items-start">
                <div className="bg-olive text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-1 flex-shrink-0">✓</div>
              ...
              <li className="flex items-start">
                <div className="bg-olive text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-1 flex-shrink-0">✓</div>
                <span>Focus on AI/ML applications and software engineering</span>
              </li>
              <li className="flex items-start">
                <div className="bg-olive text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-1 flex-shrink-0">✓</div>
