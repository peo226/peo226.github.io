      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className={cn(
                  "w-full bg-olive text-white py-3 rounded-md transition-all",
          ...
          <div>
            ...
            <p className="mb-6">
              Feel free to contact me directly through any of these channels. 
            ...
            <div className="space-y-4">
              ...
              <a 
                href="https://instagram.com/prince.0mu"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 p-3 bg-white rounded-md border border-border hover:shadow-md transition-shadow"
              >
                <div className="bg-olive/10 rounded-full p-2">
                  <Instagram className="w-5 h-5 text-olive" />
                </div>
                <div>
                  <p className="font-medium">Instagram</p>
                  <p className="text-muted-foreground">@prince.0mu</p>
                </div>
              </a>
            </div>
          </div>
