const link = "https://www.linkedin.com/in/prince-omuyeh-828517218/details/experience/";
const Experience = () => {
  return (
...
<div className="relative mb-12">
  <div className="flex flex-col md:flex-row items-start">
    ...
    <div className="md:w-1/2 md:pr-12 md:text-right ml-8 md:ml-0">
      <div className="bg-white p-6 rounded-lg shadow-sm border border-border hover:shadow-md hover:scale-105 transition-transform duration-300 ease-in-out">
        <a
          href={link} // Replace with your LinkedIn URL
          target="_blank"
